...
with(red_df, {
  ...
  plot(Time,Sub_metering_1,type="l",col="Black",xlab="",ylab="Energy sub metering",ylim=c(0,max(Sub_metering_1,Sub_metering_2,Sub_metering_3)))
